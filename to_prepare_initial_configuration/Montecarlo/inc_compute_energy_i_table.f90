...
!---------------------------------------------------------------------
!-------------------------------------------------------------------
SUBROUTINE compute_energy_i_table(this, cells, part, table, energy)
  !-----------------------------------------------------------------
  ! The energy that the presence of the particle 'part' gives to
  ! the system is computed, not directly calculating the potential,
  ! but through a table of data.
  !-----------------------------------------------------------------
...
!                 energy = energy + potential(Rij)
                 energy = energy + potential_table(table, Rij)
...
END SUBROUTINE compute_energy_i_table
