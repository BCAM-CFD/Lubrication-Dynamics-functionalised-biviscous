...
!---------------------------------------------------------------------
!-------------------------------------------------------------------
SUBROUTINE compute_energy_table(this, cells, table)
  !-----------------------------------------------------------------
  ! The energy of the whole system is calculated, not directly 
  ! calculating the potential, but through a table of data.
  !-----------------------------------------------------------------
...
END SUBROUTINE compute_energy_table
